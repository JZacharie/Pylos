...
-- Each operation must be in its own ALTER TABLE statement; otherwise PG tries to cast the
-- default value expression before dropping it ("cannot be cast automatically to type boolean")
