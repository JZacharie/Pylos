...
ALTER TABLE model_catalog
    ALTER COLUMN supports_vision DROP DEFAULT,
    ALTER COLUMN supports_tools DROP DEFAULT,
    ALTER COLUMN supports_streaming DROP DEFAULT,
    ALTER COLUMN supports_embeddings DROP DEFAULT,
    ALTER COLUMN is_deprecated DROP DEFAULT,
    ALTER COLUMN enabled DROP DEFAULT;

ALTER TABLE model_catalog
    ALTER COLUMN supports_vision TYPE BOOLEAN USING (supports_vision != 0),
    ALTER COLUMN supports_tools TYPE BOOLEAN USING (supports_tools != 0),
    ALTER COLUMN supports_streaming TYPE BOOLEAN USING (supports_streaming != 0),
    ALTER COLUMN supports_embeddings TYPE BOOLEAN USING (supports_embeddings != 0),
    ALTER COLUMN is_deprecated TYPE BOOLEAN USING (is_deprecated != 0),
...
ALTER TABLE model_catalog
    ...
    ALTER COLUMN supports_embeddings SET DEFAULT FALSE,
